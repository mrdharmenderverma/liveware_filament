...
<head>
    <meta charset="utf-8">
    <title>{{ $title ?? 'Laravel Liveware - Web App' }}</title>
        ...
        <nav class="navbar navbar-expand-xl navbar-light text-center py-3">
            <div class="container">
                <a wire:navigate class="navbar-brand" href="{{{route('home')}}}">
                    <img loading="prelaod" decoding="async" class="img-fluid" width="160" src="{{asset('frontend/images/logo.png')}}"
                        alt="Wallet">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item "> <a class="nav-link" href="team.html" wire:navigate>Our Team</a></li>
                        <li class="nav-item "><a class="nav-link " href="blog.html" wire:navigate>Blog</a></li>
